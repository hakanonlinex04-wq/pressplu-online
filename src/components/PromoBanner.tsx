...
export default function PromoBanner() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="max-w-4xl mx-auto glass-overlay bg-[#0e0e0e]/80 border border-primary/30 rounded-2xl shadow-[0_-10px_40px_rgba(229,9,20,0.15)] flex items-center justify-between p-3 sm:px-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 sm:gap-4 relative z-10 w-full">
            ...
            <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
              <a
                ...
                className="gold-gradient text-white font-extrabold px-3 sm:px-6 py-2 rounded-lg text-xs sm:text-sm flex items-center gap-1 hover:scale-105 transition-transform shadow-[0_0_15px_rgba(229,9,20,0.4)] whitespace-nowrap"
              >
