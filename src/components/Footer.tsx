...
export default function Footer() {
  return (
    <footer className="w-full py-12 px-8 bg-surface-container-low border-t border-outline-variant/10 flex flex-col items-center gap-6 text-center">
      <div className="text-3xl font-black bg-gradient-to-r from-[#ffe792] via-[#ffd709] to-[#dfb73a] bg-clip-text text-transparent drop-shadow-[0_0_15px_rgba(255,215,9,0.3)] tracking-tight">EkspressPlus TV</div>
      ...
      <p className="font-body text-sm text-on-surface-variant max-w-2xl leading-relaxed">
        © 2024 EkspressPlus tv. Tüm hakları saklıdır. Bu platform sadece test amaçlı içerik sunar.
      </p>
